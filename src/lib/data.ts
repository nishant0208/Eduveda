...
export const calendarEvents = [
    ...
    //   const date = new Date(2025, 3, 28 + i);
    //   if (date.getMonth() > 4) return null;
    //   return {
    //     title: "Lunch",
    //     allDay: false,
    ...
    //   };
    // }).filter(Boolean),
  // Added events for April 28
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 3, 28, 10, 0), // April is month 3 (0-based)
